...
def get_opt():
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints_/GMM_org/gmm_final.pth', help='model checkpoint for test')
...
def test_gmm(opt, test_loader, model, board):
    ...
    name = opt.name
    #########################################################################################改测试输出路径############################
    save_dir = os.path.join(opt.result_dir , opt.datamode, name, opt.datamode)
    print(save_dir)
...
def test_tom(opt, test_loader, model, board):
    ...
    ###############################################################################################
    save_dir = os.path.join(opt.result_dir , opt.datamode, opt.name, opt.datamode)
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
